    ...
    return (
      <View style={styles.privateState}>
        ...
        <Text style={styles.privateCopy}>
          {viewerBlockedTarget
            ? 'You have blocked this player. Unblock them to view their followers.'
            : 'This player has blocked you. Their followers are hidden.'}
        </Text>
      </View>
    );
  }
  ...
  if (!canView) {
    return (
      <View style={styles.privateState}>
        ...
        <Text style={styles.privateTitle}>Followers are hidden</Text>
        <Text style={styles.privateCopy}>
          {hasPendingRequest
            ? 'Follow request sent. Followers will be visible once it is approved.'
            : 'This account is private. Follow and wait for approval to view their followers.'}
        </Text>
      </View>
    );
  }
